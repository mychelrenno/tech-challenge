...
class UpdateRestaurantUseCaseTest {
    ...
    void testExecuteShouldUpdateRestaurant() {
        ...
        Restaurant restaurant = new Restaurant(1L, "Restaurante Atualizado", address, "Italiana", "08:00-18:00", owner);
    ...
    void testExecuteShouldReturnNullWhenNotFound() {
        ...
        Restaurant restaurant = new Restaurant(2L, "Restaurante Inexistente", address, "Japonesa", "09:00-22:00", owner);
